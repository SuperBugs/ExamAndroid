...
import static www.cjkj.com.baiyue.activity.PracticeActivity.mTiMuCursorArr;
import static www.cjkj.com.baiyue.activity.PracticeActivity.mTiMuIds;
import static www.cjkj.com.baiyue.activity.PracticeActivity.mTiMuModule;


public class PracticeDuoXuanTiFragment extends Fragment {
    private int index;
    private View ly;
    private int mPage;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        practiceActivity = (PracticeActivity) getActivity();
        setTitle();
    ...
    private void check() {
        ...
        mTiMuModule.setTiMuLianXi(PracticeActivity.mTiMuIds[index], answer, "1", result);
        PracticeActivity.changeTiMuCursorArrData(index);
    ...
    private void setAnswerListener(CheckBox checkBox) {
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String result = "1";
                if (answer.equals("")) {
                    mTiMuModule.setTiMuLianXi(PracticeActivity.mTiMuIds[index], answer, "0", result);
                    PracticeActivity.changeTiMuCursorArrData(index);
                } else {
                    if (mTiMuCursorArr[index].getString(mTiMuCursorArr[index].getColumnIndex("daan")).equals(answer)) {
                        result = "0";
