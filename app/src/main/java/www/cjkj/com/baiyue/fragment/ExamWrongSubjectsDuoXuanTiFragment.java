...
import www.cjkj.com.baiyue.activity.ExamWrongSubjectsActivity;
import www.cjkj.com.baiyue.common.CommonFunction;

import static www.cjkj.com.baiyue.activity.ExamWrongSubjectsActivity.mTiMuCursorArr;
import static www.cjkj.com.baiyue.activity.ExamWrongSubjectsActivity.mTiMuIds;
import static www.cjkj.com.baiyue.activity.ExamWrongSubjectsActivity.mTiMuModule;


public class ExamWrongSubjectsDuoXuanTiFragment extends Fragment {
    private int index;
    private View ly;
    private int mPage;
    private ExamWrongSubjectsActivity practiceActivity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        practiceActivity = (ExamWrongSubjectsActivity) getActivity();
        setTitle();
    ...
    private void check() {
        ...
        String result = "1";
        String right = mTiMuCursorArr[index].getString(mTiMuCursorArr[index].getColumnIndex("daan"));
        if (right != null) {
            if (right.equals(answer)) {
                result = "0";
                //添加错题记录
                List<Integer> wrongArr;
                wrongArr = (List<Integer>) CommonFunction.getDate(mTiMuCursorArr[index].getString(mTiMuCursorArr[index].getColumnIndex("class_kemu")) + "wrong", practiceActivity);
                if (wrongArr != null) {
                    if (!CommonFunction.listContain(wrongArr, mTiMuIds[index])) {
                        wrongArr.add(mTiMuIds[index]);
                        CommonFunction.putDate(mTiMuCursorArr[index].getString(mTiMuCursorArr[index].getColumnIndex("class_kemu")) + "wrong", wrongArr, practiceActivity);
                    }
                } else {
                    wrongArr = new ArrayList<>();
                    wrongArr.add(mTiMuIds[index]);
                    CommonFunction.putDate(mTiMuCursorArr[index].getString(mTiMuCursorArr[index].getColumnIndex("class_kemu")) + "wrong", wrongArr, practiceActivity);
                }
            }
        }
        mTiMuModule.setTiMuLianXi(ExamWrongSubjectsActivity.mTiMuIds[index], answer, "1", result);
        ExamWrongSubjectsActivity.changeTiMuCursorArrData(index);
    ...
    private void setAnswerListener(CheckBox checkBox) {
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String result = "1";
                if (answer.equals("")) {
                    mTiMuModule.setTiMuLianXi(ExamWrongSubjectsActivity.mTiMuIds[index], answer, "0", result);
                    ExamWrongSubjectsActivity.changeTiMuCursorArrData(index);
                } else {
                    if (mTiMuCursorArr[index].getString(mTiMuCursorArr[index].getColumnIndex("daan")).equals(answer)) {
                        result = "0";
