...
import www.cjkj.com.baiyue.fragment.WrongSubjectsPracticeDuoXuanTiFragment;
import www.cjkj.com.baiyue.fragment.WrongSubjectsPracticeFragment;
import www.cjkj.com.baiyue.moudel.TiMuModule;
import www.cjkj.com.baiyue.view.CommonView;

public class WrongSubjectsActivity extends FragmentActivity {
    private static final String TAG = "WrongSubjectsActivity";
    ...
    private void getObjData() {
        mTiMuIds= WrongSubjectsFragment.mWrongTiMuIds;
    ...
    private void setViewPagerView() {
        ...
        for (int i = 0; i < mTiMuCursorArr.length; i++) {
            ...
            if (mTiMuCursorArr[i].getString(mTiMuCursorArr[i].getColumnIndex("class_timu")).equals("单选题")) {
                WrongSubjectsPracticeFragment fragment = new WrongSubjectsPracticeFragment();
        ...
        for (int i = 0; i < mTiMuCursorArr.length; i++) {
            if (mTiMuCursorArr[i].getString(mTiMuCursorArr[i].getColumnIndex("class_timu")).equals("多选题")) {
                WrongSubjectsPracticeDuoXuanTiFragment fragment = new WrongSubjectsPracticeDuoXuanTiFragment();
                fragment.setSubjectsIndex(i, mPage);
                mFragments.add(fragment);
                mPage++;
            }
    ...
    private void setOnClickListener() {
        ...
        mDaTiKaIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(WrongSubjectsActivity.this, WrongSubjectsDaTiKaActivity.class);
