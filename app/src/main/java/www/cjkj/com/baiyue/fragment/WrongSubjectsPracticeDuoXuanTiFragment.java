...
import static www.cjkj.com.baiyue.activity.WrongSubjectsActivity.mTiMuIds;
import static www.cjkj.com.baiyue.activity.WrongSubjectsActivity.mTiMuModule;


public class WrongSubjectsPracticeDuoXuanTiFragment extends Fragment {
    private int index;
    private View ly;
    private int mPage;
    private WrongSubjectsActivity practiceActivity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        practiceActivity = (WrongSubjectsActivity) getActivity();
        setTitle();
        addViewPagerSonView();
        return ly;
    }
    ...
    private void addViewPagerSonView() {
        ...
        collect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                collectArr = (List<Integer>) CommonFunction.getDate(WrongSubjectsActivity.mTiMuCursorArr[index].getString(WrongSubjectsActivity.mTiMuCursorArr[index].getColumnIndex("class_kemu")) + "collect", practiceActivity);
                if (collectArr != null) {
                    if (CommonFunction.listContain(collectArr, WrongSubjectsActivity.mTiMuIds[index])) {
                        Toast.makeText(practiceActivity, "已收藏", Toast.LENGTH_SHORT).show();
                    } else {
                        collectArr.add(WrongSubjectsActivity.mTiMuIds[index]);
                        Toast.makeText(practiceActivity, "收藏成功", Toast.LENGTH_SHORT).show();
                        CommonFunction.putDate(WrongSubjectsActivity.mTiMuCursorArr[index].getString(WrongSubjectsActivity.mTiMuCursorArr[index].getColumnIndex("class_kemu")) + "collect", collectArr, practiceActivity);
                    }
                } else {
                    collectArr = new ArrayList<>();
                    collectArr.add(WrongSubjectsActivity.mTiMuIds[index]);
                    Toast.makeText(practiceActivity, "收藏成功", Toast.LENGTH_SHORT).show();
                    CommonFunction.putDate(WrongSubjectsActivity.mTiMuCursorArr[index].getString(WrongSubjectsActivity.mTiMuCursorArr[index].getColumnIndex("class_kemu")) + "collect", collectArr, practiceActivity);
                }
    ...
    private void check() {
        ...
        if (mTiMuCursorArr[index].getString(mTiMuCursorArr[index].getColumnIndex("daan")).equals(answer)) {
            result = "0";
            //取消错题
            List<Integer> wrongArr;
            wrongArr = (List<Integer>) CommonFunction.getDate(WrongSubjectsActivity.mTiMuCursorArr[index].getString(WrongSubjectsActivity.mTiMuCursorArr[index].getColumnIndex("class_kemu")) + "wrong", practiceActivity);
            if (wrongArr != null) {
                if (CommonFunction.listContain(wrongArr, WrongSubjectsActivity.mTiMuIds[index])) {
                    wrongArr.remove(wrongArr.indexOf(WrongSubjectsActivity.mTiMuIds[index]));
                    CommonFunction.putDate(WrongSubjectsActivity.mTiMuCursorArr[index].getString(WrongSubjectsActivity.mTiMuCursorArr[index].getColumnIndex("class_kemu")) + "wrong", wrongArr, practiceActivity);
                }
            }
        }
        mTiMuModule.setTiMuLianXi(WrongSubjectsActivity.mTiMuIds[index], answer, "1", result);
        WrongSubjectsActivity.changeTiMuCursorArrData(index);
    ...
    private void setAnswerListener(CheckBox checkBox){
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String result = "1";
                if(answer.equals("")){
                    mTiMuModule.setTiMuLianXi(WrongSubjectsActivity.mTiMuIds[index], answer, "0", result);
                    WrongSubjectsActivity.changeTiMuCursorArrData(index);
                }else{
                    if (mTiMuCursorArr[index].getString(mTiMuCursorArr[index].getColumnIndex("daan")).equals(answer)) {
                        result = "0";
